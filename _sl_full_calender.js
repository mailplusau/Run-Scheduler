				...
				if (stop_count != 0 && old_stop_name != stop_name) {
					if (!isNullorEmpty(old_freq_id.length)) {
						...
						if (old_freq_mon == 'T') {
							...
							var date = moment().day(1).date();
							var month = moment().day(1).month();
							var year = moment().day(1).year();
						...
						if (old_freq_tue == 'T') {
							var date = moment().day(2).date();
							var month = moment().day(2).month();
							var year = moment().day(2).year();
						...
						if (old_freq_wed == 'T') {
							var date = moment().day(3).date();
							var month = moment().day(3).month();
							var year = moment().day(3).year();
						...
						if (old_freq_thu == 'T') {
							var date = moment().day(4).date();
							var month = moment().day(4).month();
							var year = moment().day(4).year();
							...
							// nlapiLogExecution('DEBUG', 'date', moment());
						...
						if (old_freq_fri == 'T') {
							var date = moment().day(5).date();
							var month = moment().day(5).month();
							var year = moment().day(5).year();
