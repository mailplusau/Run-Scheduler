 ...
 * @Last Modified time: 2019-05-07 10:41:38
 *
 */
...
function scheduleRun(request, response) {
	if (request.getMethod() == "GET") {
		...
		for (var i = 0; i < parsedStopFreq.data.length; i++) {
			...
			if (i == 0) {
				inlineQty += '<li role="presentation" class="active"><a href="#' + obj['stop_id'] + '"  data-stopno="' + (i + 1) + '"><b>Stop ' + (i + 1) + ':</b> ' + obj['stop_name'] + '</a></li>';
				...
				inlineQty += '<li role="presentation" class=""><a href="#' + obj['stop_id'] + '"  data-stopno="' + (i + 1) + '"><b>Stop ' + (i + 1) + ':</b> ' + obj['stop_name'] + '</a></li>';
				active_class = '';
			}
			...
			if (freq_length == 1) {
				...
				tab_content += '<div class="row">';
				tab_content += '<div class="col-xs-6 difference_section"><div class="input-group"><input type="text" readonly value="DIFFERENT TIME FOR EACH DAY?" class="form-control input-group-addon"/> <span class="input-group-addon"><input type="checkbox" id="different_each_day" class=" different_each_day" data-stopno="' + (i + 1) + '" data-freqid="' + obj_freq[0]['freq_id'] + '" data-stopid="' + obj['stop_id'] + '" /></span></div></div>';
				tab_content += '</div>';
				tab_content += '</div>';
				...
				tab_content += '<div class="form-group container difference_row ">';
				tab_content += '<div class="row">';
				tab_content += '<div class="col-xs-6 difference_section"><div class="input-group"><input type="text" readonly value="DIFFERENT FOR EACH DAY?" class="form-control input-group-addon"/> <span class="input-group-addon"><input type="checkbox" id="different_each_day" class=" different_each_day" data-stopno="' + (i + 1) + '" data-multifreq="T" data-stopid="' + obj['stop_id'] + '" checked/></span></div></div>';
				tab_content += '</div>';
				tab_content += '</div>';

				tab_content += '<div class="hide form-group container run_row' + obj['stop_id'] + ' ">';
				tab_content += '<div class="row">';
				tab_content += '<div class="col-xs-6 run_section"><div class="input-group"><span class="input-group-addon" id="run_text">SELECT RUN</span><select id="run' + obj['stop_id'] + '" class="form-control run" data-stopid="' + obj['stop_id'] + '" data-freqid=""><option value="0"></option>';
				resultSet_runPlan.forEachResult(function(searchResult_runPlan) {
