...
function main(request, response) {
    ...
    if (request.getMethod() == "GET") {
        ...
        inlinehtml2 += '<li><input type="button" class="btn-xs btn-info" disabled value="2 SUSPENDED SERVICES" /> - <ul><li>Gives the number of Service(s) that are temporarily suspended, if the Customer has any.</li></ul></li>';
