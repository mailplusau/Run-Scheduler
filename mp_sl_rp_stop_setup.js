 ...
 * @Last Modified time: 2018-01-24 13:41:09
 *
 */
...
function main(request, response) {
  ...
  if (request.getMethod() == "GET") {
    ...
    resultSetCustomer.forEachResult(function(searchResult) {
      ...
      var custid = searchResult.getValue("custrecord_service_customer");
      // var entityid = searchResult.getValue('entityid', null, "GROUP");
      var companyname = searchResult.getValue("companyname", "CUSTRECORD_SERVICE_CUSTOMER", null);

      var service_id = searchResult.getValue("internalid", "CUSTRECORD_SERVICE", null);
